...
derepFs <- derepFastq(filtFs, verbose=TRUE)  #verbose=on lui demande d'expliquer les étapes qu'il fait
...
mergers <- mergePairs(dadaFs, derepFs, dadaRs, derepRs)   #on aligne les reads F et R
seqtabAll <- makeSequenceTable(mergers[!grepl("Mock", names(mergers))])  #nb de fois que chaq séqces apparaît ds chaq
