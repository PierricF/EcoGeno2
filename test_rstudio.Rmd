...
derepFs <- derepFastq(filtFs, verbose=TRUE)  #verbose=on lui demande d'expliquer ce qu'il fait
...
samdf <- read.cdv("https://raw.githubusercontent.com/spholmes/F1000_workflow/master/data/MIMARKS_Data_combined.csv",header=TRUE)
